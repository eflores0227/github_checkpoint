...
RSpec.describe AddressBook do
  ...
  describe "remove_entry" do
    it "removes an entry using the name, phone_number, email" do
      ...
      book.add_entry('John Doe', '001.234.5678','jd@jd.com')
  ...
  describe "import from entries_2.csv" do
    ...
    it "imports the 1st entry" do
      book.import_from_csv("entries_2.csv")
      entry_one = book.entries[0]
      check_entry(entry_one, "Julie", "555-555-1298", "julie@blocmail.com")
    end
    it "imports the 2nd entry" do
      book.import_from_csv("entries_2.csv")
      entry_two = book.entries[1]
      check_entry(entry_two, "Juniper", "555-555-9878", "juniper@blocmail.com")
    end
    it "imports the 3rd entry" do
      book.import_from_csv("entries_2.csv")
      entry_three = book.entries[2]
      check_entry(entry_three, "Justin", "555-555-0156", "justin@blocmail.com")
    end
  end
